...
export default function SearchUserCard({  user,curUser  }) {
  const opts = {
    headers: {
  ...
  return (
    // <Paper>
      ...
      <CardActions className="cardAction">
        ...
        <CardActions className="cardAction">
        <Button className ="friendCardBtn" size="medium" style={{  width:"100%" , backgroundColor: "#2374E1", color:"#F3F8FE"  }} onClick={handleRemoveClick}>
          Xem trang cá nhân
        </Button>
      </CardActions>
    </Card>
